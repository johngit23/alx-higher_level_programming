...
In this project, I practiced object-oriented programming in Python. It covers class methods, static methods, class vs instance attributes, and how to use the special `__str__` and `__repr__` methods.
